...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Order statistics DTO", title = "Order Statistics")
public class OrderStatisticsDto {
    ...
    @Schema(description = "Average order value today", example = "1000.00")
    private BigDecimal averageOrderValueToday;

    @Schema(description = "Average order value this week", example = "1005.75")
    private BigDecimal averageOrderValueWeek;

    @Schema(description = "Average order value this month", example = "1000.00")
